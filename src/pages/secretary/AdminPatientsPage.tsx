...
import {
  PatientListCard,
  type PatientData,
} from "../../components/patients/PatientListCard";
...
export default function AdminPatientsPage() {
  ...
  const [statusFilter, setStatusFilter] = useState<PatientStatus | "Todos">(
    "Todos"
  );
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-4">
        <SummaryStatCard value={totalActivos} label="Pacientes Activos" />
        <SummaryStatCard value={totalConCitas} label="Con Citas Programadas" />
        <SummaryStatCard value={totalCitas} label="Total de Citas" />
      </div>
    </div>
  );
}
