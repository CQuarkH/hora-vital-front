...
describe('HomePage', () => {
    ...
    it('debe mostrar el spinner de carga', () => {
        ...
        expect(screen.getByText('', { selector: 'div.animate-spin' })).toBeInTheDocument();
    });
