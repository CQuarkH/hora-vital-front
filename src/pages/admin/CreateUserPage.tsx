...
export default function CreateUserPage() {
    ...
    const onSubmit = async (data: CreateUserFormValues) => {
        ...
        alert(`Usuario ${data.firstName} creado con el rol de ${data.role}`);
        navigate('/home');
    };
    ...
    return (
        <div className="max-w-4xl mx-auto">
            ...
            <p className="text-gray-600 mb-6">
                Registra un nuevo usuario en el sistema (ej. Secretario/a).
            </p>
            ...
            >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <Input
                        ...
                        {...register("rut", { 
                            ...
                            pattern: { value: /^\d{1,2}\.\d{3}\.\d{3}-[\dkK]$/, message: "Formato de RUT inválido" }
                        })}
                    />
                    <Input
                        label="Teléfono"
                ...
                <button
                    type="submit"
                    className="mt-4 bg-medical-700 text-white px-4 py-3 rounded-lg hover:bg-medical-800"
                >
                    Registrar Usuario
                </button>
            </form>
