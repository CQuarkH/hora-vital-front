...
import type { Notification, NotificationType, NotificationPriority } from '../../types/notification/notification_types';
...
export const NotificationCard: React.FC<NotificationCardProps> = ({ 
    ...
    const { id, type, title, message, timestamp, priority, isRead } = notification;
        ...
        >
            ...
            <div className="flex-1">
                <div className="flex items-center gap-2">
                    ...
                    {!isRead && (
                        <span className="h-2 w-2 bg-green-500 rounded-full" title="No leído"></span>
                    )}
                </div>
